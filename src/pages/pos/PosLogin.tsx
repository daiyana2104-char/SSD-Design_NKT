      ...
      <div className="w-full max-w-md">
        <div className="card p-8">
          <div className="mb-6 text-center">
            ...
            <p className="text-sm text-brown-500">POS Counter Login</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex cursor-pointer items-center gap-2 text-sm text-brown-600">
                <input type="checkbox" checked={remember} onChange={(e) => setRemember(e.target.checked)} className="h-4 w-4 accent-maroon-600" />
                Remember Me
              </label>
              <button type="button" className="text-sm text-maroon-600 hover:underline">Forgot Password?</button>
            </div>
        ...
        <div className="mt-4 rounded-lg bg-cream-50 p-3 text-center text-xs text-brown-400">
          <p>Demo: <strong>posuser</strong> / <strong>Temple@123</strong></p>
        </div>
      </div>
    </div>
  );
