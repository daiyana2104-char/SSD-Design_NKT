...
export function AdditionalServiceMaster() {
  ...
  const openCreate = () => { setEditing(null); setForm({ code: '', name: '', pricingType: 'Fixed', rate: 0, gstApplicable: false, status: 'Active' }); setModalOpen(true); };
  ...
  const columns: Column<AdditionalService>[] = [
    ...
    { key: 'gst', header: 'GST', render: (r) => r.gstApplicable ? 'Yes' : 'No' },
